...
export const computerScienceQuestions: Question[] = [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'The current best bound for matrix multiplication is $O(n^{2.3716})$ by Alman and Williams (2024), improving on the Coppersmith-Winograd line of research.',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'Scaled dot-product attention divides by $\\sqrt{d_k}$ to prevent softmax saturation, then applies the softmax to get attention weights over values $V$.',
