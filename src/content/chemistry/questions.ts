...
export const chemistryQuestions: Question[] = [
  ...
  // ── Physical Chemistry expansion ────────────────────────────
  {
    ...
    options: ['$dS = \delta q_{rev}/T, '$dS = \delta q_{rev}T, '$dS = \delta w_{rev}/T, '$dS = C_pT],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['Pressure is inversely proportional to volume', 'Pressure is directly proportional to volume', 'Volume is inversely proportional to temperature', 'Pressure is independent of volume'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['The reaction Gibbs energy satisfies $\\Delta_r G = 0, 'The standard Gibbs energy satisfies $\\Delta_r G^\\circ = 0$ for every reaction', 'The enthalpy change is zero', 'All reactant and product concentrations are equal'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['$\\log \\gamma_i \\propto -z_i^2\\sqrt{I}, '$\\log \\gamma_i \\propto +z_i\\,I^2, '$\\gamma_i = 1+z_iI$ exactly at all concentrations', '$\\log \\gamma_i \\propto -I/z_i^2],
    correctIndex: 0,
  ...
  },
  {
    ...
    sources: [{ title: 'E(3)-equivariant graph neural networks for data-efficient and accurate interatomic potentials', url: 'https://doi.org/10.1038/s41467-022-29939-5', publisher: 'Nature Communications', year: 2022 }],
    reviewedAt: '2026-09-19',
  ...
  },
  {
    ...
    hint: 'The acronym’s advance is not “more layers”; it is richer many-body information inside each equivariant message.',
    sources: [{ title: 'MACE: Higher Order Equivariant Message Passing Neural Networks for Fast and Accurate Force Fields', url: 'https://papers.neurips.cc/paper_files/paper/2022/hash/4a36c3c51af11ed9f34615b81edb5bbc-Abstract-Conference.html', publisher: 'NeurIPS', year: 2022 }],
    reviewedAt: '2026-09-19',
    factualAsOf: '2026-09-19',
  },

  // ── Organic Chemistry expansion ─────────────────────────────
  {
    ...
    options: ['$4n+2$ π electrons', '$4n$ π electrons', 'Exactly 2 π electrons regardless of ring size', 'An even number of sigma bonds'],
    correctIndex: 0,
  ...
  },
  {
    ...
    sources: [{ title: 'Low-energy photoredox catalysis', url: 'https://doi.org/10.1038/s41570-024-00663-6', publisher: 'Nature Reviews Chemistry', year: 2025 }],
    reviewedAt: '2026-09-19',
    factualAsOf: '2026-09-19',
  },
  {
    ...
    sources: [{ title: 'Synergistic Photoredox and Electrochemical Catalysis in Organic Synthesis and Late-Stage Functionalizations', url: 'https://doi.org/10.1002/cctc.202301537', publisher: 'ChemCatChem', year: 2024 }],
    reviewedAt: '2026-09-19',
    factualAsOf: '2026-09-19',
  },
  ...
  },
  {
    ...
    sources: [{ title: 'Cooperative insertion of CO2 in diamine-appended metal-organic frameworks', url: 'https://doi.org/10.1038/nature14327', publisher: 'Nature', year: 2015 }],
    reviewedAt: '2026-09-19',
    factualAsOf: '2026-09-19',
  },
  {
    ...
    sources: [{ title: 'Rational Design of Heteroatom-Doped Fe–N–C Single-Atom Catalysts for Oxygen Reduction Reaction via Simple Descriptor', url: 'https://doi.org/10.1021/acscatal.4c01377', publisher: 'ACS Catalysis', year: 2024 }],
    reviewedAt: '2026-09-19',
    factualAsOf: '2026-09-19',
  },
