...
export const sota2026Questions: Question[] = [
  // 1) AgentSkiller: Scaling Generalist Agents
  {
    ...
    question: `In AgentSkiller, why does a DAG-based architecture with explicit state transitions enable reliable, privacy-safe data synthesis for agent training?`,
    options: [
    ...
    realWorld:
      "AgentSkiller lets teams train tool-using agents on synthetic-but-verifiable interaction traces without ingesting sensitive customer logs.",
  ...
  // 2) ALMA: Meta-Learning Agentic Memory
  {
    ...
    question: `In ALMA, how does expressing memory as searchable executable code allow it to outperform fixed human-designed memory modules across diverse domains?`,
    options: [
  ...
  // 3) LLaDA2.1: Token Editing for Diffusion LMs
  {
    ...
    question: `In LLaDA 2.1, why does lowering the Mask-to-Token (M2T) threshold in Speedy Mode require Token-to-Token (T2T) editing to maintain generation quality?`,
    options: [
  ...
  // 4) InftyThink+: Infinite-Horizon Reasoning
  {
    ...
    question: `What "lost-in-the-middle" problem does InftyThink+ solve, and how does RL-based summarisation help?`,
    options: [
    ...
    realWorld:
      "This mirrors how humans write sub-lemmas and summaries to keep long proofs manageable without rereading everything.",
  ...
  // 5) EnvScaler: Scaling Tool Environments
  {
    ...
    realWorld:
      "EnvScaler enables training agents that generalize to novel interfaces and workflows without relying on production user data.",
    hint: "The product $|D| \\times |T| \\times H$ grows combinatorially — what does that imply for variety?",
  },

  // 6) Block Diffusion Scaling
  {
    id: 20260006,
    topic: "sota-2026",
    difficulty: "sota",
    ...
    realWorld:
      `High-speed diffusion LMs enable "instant" drafting where large chunks appear in seconds rather than minutes.`,
  ...
  // 7) Statelessness bottleneck + ALMA-style memory
  {
    ...
    realWorld:
      `ALMA-style memory is a path toward assistants that remember your org's conventions and workflows over weeks/months without manual prompt scaffolding.`,
    hint: `What's the difference between having short-term context and having long-term memory?`,
  },

  // 8) RL for diffusion LLMs
  {
    id: 20260008,
    topic: "sota-2026",
    difficulty: "sota",
    ...
    question:
      "What diffusion-specific challenges does RL (PPO) address when aligning diffusion language models like LLaDA 2.1, compared to standard autoregressive RLHF?",
    options: [
    ...
    realWorld:
      `Aligning diffusion LMs supports tools that iteratively "sculpt" a draft into a final document rather than committing to a single left-to-right decode.`,
  ...
  // 9) Cross-Domain Agent Fusion
  {
    ...
    question: `In AgentSkiller's cross-domain fusion, how do Person-Centric Entity Graphs ensure semantic consistency when linking services?`,
    options: [
    ...
    realWorld:
      "This enables an agent to sync bookings with calendars or CRMs while maintaining entity consistency across different schemas.",
    hint: "If embeddings encode meaning, what does that imply about which entities should connect?",
  },

  // 10) Iterative Reasoning Optimization
  {
    id: 20260010,
    topic: "sota-2026",
    difficulty: "sota",
    ...
    realWorld:
      `Iterative reasoning techniques are aimed at making "deep thinking" affordable by preventing huge quadratic slowdowns.`,
  ...
  // 11) Unified Latents
  {
    ...
    difficulty: "sota",
    paper: {
      title: "Unified Latents",
      url: "https://arxiv.org/abs/2602.17270",
    },
    symbolLinks: {
      "\\lambda": "lambda",
    },
    question: `In DeepMind's Unified Latents, how does the "Information Density Seesaw" get resolved to achieve a SOTA 1.3 FVD on Kinetics-600?`,
    options: [
  ...
  // 12) ResearchGym
  {
    ...
    question: `According to ResearchGym, what is the primary reason frontier agents struggle with autonomous AI research despite high reasoning scores?`,
    options: [
    ...
    realWorld:
      `The next frontier is less about one-shot IQ and more about multi-day "project management" reliability.`,
  ...
  // 13) HalluHard
  {
    ...
    question: `How does the HalluHard benchmark differentiate itself from previous hallucination metrics like TruthfulQA?`,
    options: [
    ...
    realWorld:
      `"Groundedness" is critical for legal/medical agents where one early error can poison many downstream steps.`,
  ...
  // 14) R2C / CIR
  {
    ...
    question: `In the R2C framework, how does the Canonical Intermediate Representation (CIR) improve optimization problem solving?`,
    options: [
    ...
    correctIndex: 0,
    explanation:
      `CIR acts like a schema/bridge: before committing to equations, the solver identifies constraint archetypes and modeling paradigms that represent the rules. This modularity reduces early translation errors that commonly derail direct NL-to-math approaches.`,
    realWorld:
      "R2C is aimed at real logistics/supply-chain settings where rules are messy and mapping them cleanly to constraints is the hardest step.",
  ...
  // 15) First Proof
  {
    ...
    question: `Why did the authors of First Proof encrypt the answers to their research-level math questions for a short period?`,
    options: [
    ...
    realWorld:
      "This represents a peak evaluation regime: problems whose solutions are intentionally withheld to avoid contamination.",
  ...
  // 16) International AI Safety Report 2026
  {
    ...
    difficulty: "sota",
    paper: {
      title: "AI Safety Report 2026",
      url: "https://arxiv.org/abs/2602.21012",
    },
    question: `The International AI Safety Report 2026, led by Yoshua Bengio, identifies which of these as a primary "Emerging Risk"?`,
    options: [
    ...
    realWorld:
      "This report is positioned as a scientific baseline for governance that shifts concern from chatbots to deployed autonomous agents.",
  ...
  // 17) Empirical-MCTS
  {
    ...
    difficulty: "sota",
    paper: {
      title: "Empirical-MCTS",
      url: "https://arxiv.org/abs/2602.04248",
    },
    question: `In Empirical-MCTS, how does "Dual Process" evolution enable agents to improve over time without manual fine-tuning?`,
    options: [
    ...
    realWorld:
      `This captures the "practice, evaluate, internalize" loop that enables agents to improve on the job.`,
  ...
  // 18) LogicGraph
  {
    ...
    question: `What does the LogicGraph benchmark measure that traditional benchmarks like GSM8K miss?`,
    options: [
    ...
    realWorld:
      "This aligns with real reliability needs: agents must cross-check reasoning rather than getting lucky once.",
    hint: "If all roads lead to Rome, can the model take more than one road?",
  },

  // 19) Attention Matching
  {
    id: 20260019,
    topic: "sota-2026",
    difficulty: "sota",
    ...
    realWorld:
      "This kind of compaction is critical for long-context advances where models need to handle millions of tokens efficiently.",
  ...
  // 20) GLM-5: Agentic Engineering shift
  {
    ...
    realWorld:
      `This "continuous agent evolution" framing is discussed broadly in 2026 agent systems literature.`,
