...
export const cybersecurityExpansionQuestions: Question[] = [
  {
    ...
    options: ['It requires evidence from more than one authentication factor', 'It encrypts every file on the device automatically', 'It prevents all phishing messages from being delivered', 'It makes account passwords unnecessary in every system'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['They keep supplied values separate from SQL command structure', 'They hide the database server from the network', 'They make every database column read-only', 'They automatically encrypt every returned row'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['Only the permissions needed for its required tasks', 'Administrator access in case it is needed later', 'The same permissions as every other account', 'No logging when privileged operations are performed'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['Execute as active script in another user’s browser context', 'Change a DNS record without any credentials', 'Read encrypted disk sectors without a key', 'Bypass network routing and address translation'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['They can preserve recoverable data even if production systems are encrypted or deleted', 'They guarantee ransomware cannot enter the network', 'They reveal every attacker’s identity before an incident', 'They remove the need to patch vulnerable systems'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['Govern', 'Encrypt', 'Authenticate', 'Isolate'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['An organization’s current or target cybersecurity posture in terms of CSF Core outcomes', 'A ranked list of individual employee security scores', 'A mandatory catalog of specific security products', 'A cryptographic identity certificate for the organization'],
    correctIndex: 0,
