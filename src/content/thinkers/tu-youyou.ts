...
export const tuYouyouQuestions: Question[] = [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'Artemisinin contains an unusual 1,2,4-trioxane ring with an endoperoxide bridge. Inside the malaria parasite, Fe²⁺ from digested hemoglobin reductively cleaves the O-O bond, generating reactive oxygen species and carbon radicals that alkylate parasite proteins. This mechanism explains why artemisinin is selectively toxic to infected red blood cells.',
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'K13 propeller mutations (e.g., C580Y) are the validated molecular markers for artemisinin resistance. They don\'t prevent drug activation but instead allow ring-stage parasites to become dormant during drug exposure and resume growth afterward. The mechanism involves upregulated PI3P lipid signaling and enhanced proteostasis pathways.',
