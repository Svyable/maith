...
// Fields Medalists & foundational minds (batch 2)
import { pierreDeligneQuestions } from "./pierre-deligne";
import { johnMilnorQuestions } from "./john-milnor";
import { ghHardyQuestions } from "./gh-hardy";
import { arturAvilaQuestions } from "./artur-avila";
import { vladimirVoevodskyQuestions } from "./vladimir-voevodsky";
import { simonDonaldsonQuestions } from "./simon-donaldson";
import { vaughanJonesQuestions } from "./vaughan-jones";
import { reneThomQuestions } from "./rene-thom";
...
// Statistical Learning & History
  ...
  // Fields Medalists & foundational minds (batch 2)
  ...pierreDeligneQuestions,
  ...johnMilnorQuestions,
  ...ghHardyQuestions,
  ...arturAvilaQuestions,
  ...vladimirVoevodskyQuestions,
  ...simonDonaldsonQuestions,
  ...vaughanJonesQuestions,
  ...reneThomQuestions,
  ...
  // Chemistry Legends (batch 2)
  ...friedrichWohlerQuestions,
  ...augustKekuleQuestions,
  ...justusVonLiebigQuestions,
  ...williamPerkinQuestions,
  ...hermannKolbeQuestions,
  ...williamRamsayQuestions,
  ...robertBunsenQuestions,
  ...heitlerLondonQuestions,
  ...johnPopleQuestions,
  ...fischerWilkinsonQuestions,
  ...georgeOlahQuestions,
  ...robertGrubbsQuestions,
  ...barrySharplessQuestions,
  ...heegerMacdiarmidShirakawaQuestions,
  ...emilFischerQuestions,
  ...perutzKendrewQuestions,
  ...anastasWarnerQuestions,
  ...jamesLovelockQuestions,
  ...lehnCramPedersenQuestions,

  // Biology & Medicine Legends
  ...williamHarveyQuestions,
  ...andreasVesaliusQuestions,
  ...hippocratesQuestions,
  ...galenQuestions,
  ...paulEhrlichQuestions,
  ...josephListerQuestions,
  ...rudolfVirchowQuestions,
  ...santiagoRamonYCajalQuestions,
  ...ignazSemmelweisQuestions,
  ...elizabethGarrettAndersonQuestions,
  ...shushrutaQuestions,
  ...ibnSinaQuestions,
  ...virginiaApgarQuestions,
