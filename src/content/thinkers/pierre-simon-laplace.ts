...
export const pierreSimonLaplaceQuestions: Question[] = [
  {
    id: 420001, topic: 'pierre-simon-laplace', difficulty: 'easy',
  ...
  {
    id: 420002, topic: 'pierre-simon-laplace', difficulty: 'hard',
  ...
  {
    id: 420003, topic: 'pierre-simon-laplace', difficulty: 'sota',
