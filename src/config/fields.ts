...
export const FIELDS: FieldMeta[] = [
  ...
  },
  {
    ...
    topics: ['linear-algebra', 'calculus', 'probability-stats', 'optimization', 'discrete-math', 'number-theory', 'real-analysis', 'topology', 'differential-equations', 'abstract-algebra'],
    color: 'accent',
    available: true,
  },
  {
  ...
  },
  {
    ...
    topics: ['algorithms', 'machine-learning', 'cryptography', 'ai-models', 'quantum-computing', 'cybersecurity', 'distributed-systems', 'operating-systems'],
    color: 'accent',
    available: true,
  },
  {
  ...
  },
  {
    ...
    topics: ['stochastic-calculus', 'derivatives-pricing', 'risk-management', 'portfolio-theory', 'fixed-income', 'algo-trading'],
    color: 'destructive',
    available: true,
  },
  {
